# Alertas de vencimiento de Farmacia Specification
...
- **THEN** el sistema SHALL conservar la fecha, la cantidad, el estado activo y los demás datos persistidos del lote
