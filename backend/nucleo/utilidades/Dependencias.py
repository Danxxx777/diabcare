...
PERMISOS_MODULOS = {
    ...
    "comorbilidades":   ["administrador", "medico", "enfermero", "analista"],
    "comorbilidades_diagnosticar": ["administrador", "medico"],
    "comorbilidades_seguimiento":  ["administrador", "medico", "enfermero"],
