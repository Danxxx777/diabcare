...
from servicios.notificaciones.NotificacionesServicio import (
    listar, crear, marcar_todas_leidas, evaluar_todas,
)
...
@router.post("/evaluar")
def evaluar_alertas(payload: dict = Depends(require_modulo("notificaciones"))):
    """CU-O10 + CU-O16: evalúa alertas clínicas y de churn."""
